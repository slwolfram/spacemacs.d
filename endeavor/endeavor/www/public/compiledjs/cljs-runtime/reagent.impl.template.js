...
var G__21678 = o;
reagent.impl.template.goog$module$goog$object.set(G__21678,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__21701__delegate = function (args){
...
while (G__21702__i < G__21702__a.length) {G__21702__a[G__21702__i] = arguments[G__21702__i + 0]; ++G__21702__i;}
  args = new cljs.core.IndexedSeq(G__21702__a,0,null);
} 
return G__21701__delegate.call(this,args);};
G__21701.cljs$lang$maxFixedArity = 0;
G__21701.cljs$lang$applyTo = (function (arglist__21703){
var args = cljs.core.seq(arglist__21703);
return G__21701__delegate(args);
});
...
var G__21679 = o;
reagent.impl.template.goog$module$goog$object.set(G__21679,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__21704__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__21705__i < G__21705__a.length) {G__21705__a[G__21705__i] = arguments[G__21705__i + 0]; ++G__21705__i;}
  args = new cljs.core.IndexedSeq(G__21705__a,0,null);
} 
return G__21704__delegate.call(this,args);};
...
return G__21704__delegate(args);
});
...
var G__21680 = props;
var G__21680__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21680,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21680);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21680__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__21680__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21681 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21681,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21681;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__21682){
var map__21683 = p__21682;
var map__21683__$1 = cljs.core.__destructure_map(map__21683);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21683__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__21684_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__21684_SHARP_);
}));
} else {
return null;
}
...
var vec__21686 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21686,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21686,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21686,(2),null);
...
var temp__5757__auto___21708 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___21708 == null)){
} else {
var key_21709 = temp__5757__auto___21708;
(jsprops.key = key_21709);
}
...
var temp__5757__auto___21710 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___21710 == null)){
} else {
var key_21711 = temp__5757__auto___21710;
(jsprops.key = key_21711);
}
...
var G__21690 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__21690) : reagent.impl.template.as_element.call(null,G__21690));
} else {
var temp__5757__auto___21712 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___21712 == null)){
} else {
var key_21713 = temp__5757__auto___21712;
(jsprops.key = key_21713);
}
...
var G__21692 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__21692)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__21692)){
return x;
} else {
...
var len__4864__auto___21714 = arguments.length;
var i__4865__auto___21715 = (0);
while(true){
if((i__4865__auto___21715 < len__4864__auto___21714)){
args__4870__auto__.push((arguments[i__4865__auto___21715]));

var G__21716 = (i__4865__auto___21715 + (1));
i__4865__auto___21715 = G__21716;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21693){
var G__21694 = cljs.core.first(seq21693);
var seq21693__$1 = cljs.core.next(seq21693);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21694,seq21693__$1);
}));
...
break;
default:
var G__21718 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__21718;
continue;
...
var ctx = ({});
var vec__21697 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21697,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21697,(1),null);
...
var G__21700 = (cljs.core.count(argv) - first_child);
switch (G__21700) {
case (0):
