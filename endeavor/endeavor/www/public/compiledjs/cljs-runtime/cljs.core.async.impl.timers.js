...
while(true){
if((i <= self__.level)){
var links_14398 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14398[i]));
} else {
x__$2.forward.push((((i < links_14398.length))?(links_14398[i]):null));
}

if((i < links_14398.length)){
(links_14398[i] = x__$2);
} else {
links_14398.push(x__$2);
}
...
var i_14400 = (0);
while(true){
if((i_14400 <= self__.level)){
var links_14401 = (update[i_14400]).forward;
if((x__$1 === (((i_14400 < links_14401.length))?(links_14401[i_14400]):null))){
(links_14401[i_14400] = (x__$1.forward[i_14400]));

var G__14402 = (i_14400 + (1));
i_14400 = G__14402;
continue;
} else {
var G__14403 = (i_14400 + (1));
i_14400 = G__14403;
continue;
}
} else {
