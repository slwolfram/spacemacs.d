...
return [(function (){var pred__21847 = cljs.core.instance_QMARK_;
var expr__21848 = reactive_val;
if(cljs.core.truth_((pred__21847.cljs$core$IFn$_invoke$arity$2 ? pred__21847.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__21848) : pred__21847.call(null,reagent.ratom.RAtom,expr__21848)))){
return "ra";
} else {
if(cljs.core.truth_((pred__21847.cljs$core$IFn$_invoke$arity$2 ? pred__21847.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__21848) : pred__21847.call(null,reagent.ratom.RCursor,expr__21848)))){
return "rc";
} else {
if(cljs.core.truth_((pred__21847.cljs$core$IFn$_invoke$arity$2 ? pred__21847.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__21848) : pred__21847.call(null,reagent.ratom.Reaction,expr__21848)))){
return "rx";
} else {
if(cljs.core.truth_((pred__21847.cljs$core$IFn$_invoke$arity$2 ? pred__21847.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__21848) : pred__21847.call(null,reagent.ratom.Track,expr__21848)))){
return "tr";
} else {
return "other";
}
